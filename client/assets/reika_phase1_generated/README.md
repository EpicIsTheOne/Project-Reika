# Reika Phase 1 Generated Asset Pack

This is the corrected Phase 1 asset pack: new project-local assets generated from the supplied Reika and Reika references.

Use this folder for the prototype:

`assets/reika_phase1_generated/`
...
- `brand/reika_logo_icon_alpha.png`
- `brand/reika_wordmark_text_alpha.png`
- `brand/reika_combined_deterministic_alpha.png`
