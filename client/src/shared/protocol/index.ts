...
export type AgentChatRequestEnvelope = AgentHubEnvelope<{ providerId?: string; agent?: string; sessionId?: string; message: string; model?: string }> & { type: "agent.chat.request" };
