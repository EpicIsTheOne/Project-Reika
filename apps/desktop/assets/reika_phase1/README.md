# Reika Phase 1 Reika Asset Pack

This folder contains the first usable visual slice for Reika, extracted from the supplied Reika and Reika reference sheets.
...
- `brand/` - Reika logo, wordmark, app icon, tray icon, loading emblems, plus alpha variants where useful.
